                    ...
                    <div class="card-body">
                        ...
                        >
                            ...
                            <div class="col-md-6 m-auto">
                                ...
                                <input type="hidden" name="brandId" value="{{$brand->brandId}}" class="form-control" id="brandName">
                                <input type="text" name="brandName" value="{{$brand->brandName}}" class="form-control" id="brandName">
                                @error('brandName')
