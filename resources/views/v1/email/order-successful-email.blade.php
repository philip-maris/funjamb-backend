                                        ...
                                        <div style="font-family: Tahoma, Verdana, sans-serif">
                                            ...
                                            <div class="txtTinyMce-wrapper"
                                                ...
                                                <p style="margin: 0; font-size: 16px; text-align: left; letter-spacing: normal;">
                                                            <span style="font-size:15px;">Dear {{ $fullName }}<br><br>
                                                               Welcome to our store! <br><br>
                                                                We are super excited to see you join the KOSMAN family.
                                                                Make yourself at home and take pleasure in shopping with us. <br><br>
                                                            </span>
                                                </p>
                                                ...
                                                <p style="margin: 0; font-size: 10px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;">
                                                    <span style="font-size: 15px;">Enjoy your shopping.</span></p>
                                                <p style="margin: 0; font-size: 16px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;"></p>
                                                <br>
                                            </div>
                                        </div>
                                            ...
                                            <div class="txtTinyMce-wrapper"
                                                ...
                                                <p style="margin: 0; font-size: 16px; text-align: left; letter-spacing: normal;">
                                                            <span
                                                               ...
                                                               Welcome to our store! <br><br>
                                                                We are super excited to see you join the KOSHMAN family.
                                                                Make yourself at home and take pleasure in shopping with us. <br><br>
                                                            </span>
                                                </p>
                                                <p style="margin: 0; font-size: 16px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;"></p>
