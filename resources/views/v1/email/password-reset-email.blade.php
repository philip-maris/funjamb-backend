                                ...
                                <tr>
                                    <td style="padding-left:30px;padding-right:30px;">
                                        ...
                                        <div style="font-family: Tahoma, Verdana, sans-serif">
                                            <strong>SUCCESSFUL PASSWORD RESET</strong>
                                            <div class="txtTinyMce-wrapper"
                                                ...
                                                <p style="margin: 0; font-size: 10px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;">
                                                    <span style="font-size: 15px;">If you did not make this request, contact us on <a
                                                                href="">09134102907 <span style="color: #5f6163"></span></a> or send an email to  <a
                                                                href=""><span>support@bizgem.io</span> </a> immediately.</span>
                                                </p>
                                                <p style="margin: 0; font-size: 16px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;"></p>
                                                <br>
                                            </div>
